...
Last modified 8/28/15 by Beefheart
*/
	/**************************************************************
	...
	**************************************************************/
	...
	// Note that there should not be a comma after the last item in this table
		[[14566,16773,0],900]	//Trader city at Airfield
	];
	...
	***********************************************************/
	...
	blck_useSignalEnd = false; // When true a smoke grenade will appear at the loot crate for 2 min after mission completion.
	...
	//Defines how many AI Vehicles to spawn. Set this to -1 to disable spawning of static weapons or vehicles. To discourage players running with with vehicles, spawn more B_GMG_01_high
	...
	****************************************************************/
	...
	blck_brdcstkillmsg = false;
	// Killmessage to killer.
	blck_playerkillmsg = true;
...
***************************************************************************************/
	...
	// values are: number of things from the weapons, magazines, optics, materials, items (food etc) and backpacks arrays to add, respectively.

	blck_lootCountsMajor = [8,24,8,12,12,4];   // Orange
	blck_BoxesLoot_Major =
		// Loot is grouped as [weapons],[magazines],[optics],[materials],[items],[backpacks] in order to be able to use the correct function to load the item into the crate later on.
		...
		[
			[// Weapons
				...
				["arifle_MXM_F","30Rnd_65x39_caseless_mag"],["arifle_MXM_F","30Rnd_65x39_caseless_mag"],
				...
				["srifle_DMR_01_F","10Rnd_762x55_Mag"],
				["srifle_LRR_F","7Rnd_408_Mag"],
				["srifle_EBR_F","20Rnd_762x51_Mag"],
				["srifle_GM6_F","5Rnd_127x108_APDS_Mag"],
				["LMG_Mk200_F","200Rnd_65x39_cased_Box_Tracer"],["LMG_Mk200_F","200Rnd_65x39_cased_Box_Tracer"],
				["Arifle_MX_SW_F","100Rnd_65x39_caseless_mag"],["Arifle_MX_SW_F","100Rnd_65x39_caseless_mag"],
				["Arifle_MX_SW_Black_F","100Rnd_65x39_caseless_mag"],["Arifle_MX_SW_Black_F","100Rnd_65x39_caseless_mag"],
			...
			[//Magazines
				["3rnd_HE_Grenade_Shell",3,4],
				["30Rnd_65x39_caseless_green",3,4],
				["20Rnd_762x51_Mag",5,5],["20Rnd_762x51_Mag",5,5],
				["10Rnd_762x55_Mag",3,3],["10Rnd_762x55_Mag",3,3],
				["200Rnd_65x39_cased_Box",3,3],
				["100Rnd_65x39_caseless_mag",3,4],
				["HandGrenade",1,4],
				["10Rnd_338_Mag",1,4],["10Rnd_338_Mag",1,4],
				["10Rnd_127x54_Mag",1,4],["10Rnd_127x54_Mag",1,4],
				["10Rnd_93x64_DMR_05_Mag",1,4],["10Rnd_93x64_DMR_05_Mag",1,4]
			],
			[  // Attachments
				["muzzle_snds_H",1,0],["muzzle_snds_H_MG",1,0],
				["muzzle_snds_338_black",1,0],["muzzle_snds_338_green",1,0],["muzzle_snds_338_sand",1,0],
				["muzzle_snds_93mmg",1,0],["muzzle_snds_93mmg_tan",1,0],
				["optic_KHS_blk",1,0],["optic_KHS_hex",1,0],["optic_KHS_old",1,0],["optic_KHS_tan",1,0],
				["optic_AMS",1,0],["optic_AMS_khk",1,0],["optic_AMS_snd",1,0],
				["optic_LRPS",1,0],["optic_LRPS",1,0],
				["optic_Nightstalker",1,0],
				["optic_tws",1,0]
			],
			[// Basebuilding & hardware
				["Exile_Item_WoodFloorKit",4,6],["Exile_Item_WoodFloorKit",4,6],["Exile_Item_WoodFloorKit",4,6],["Exile_Item_WoodFloorKit",4,6],
				["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],
				["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],
				["Exile_Item_DuctTape",2,3],["Exile_Item_DuctTape",2,3],
				["Exile_Item_JunkMetal",1,2],["Exile_Item_JunkMetal",1,2],["Exile_Item_JunkMetal",1,3],["Exile_Item_JunkMetal",1,3],
				["Exile_Item_MetalBoard",1,1],["Exile_Item_MetalBoard",1,1],["Exile_Item_MetalBoard",1,1],
				["Exile_Item_CamoTentKit",1,0]
			],
			[//Items
				["Rangefinder",1,0],["Rangefinder",1,0],["Rangefinder",1,0],
				["ItemGPS",1,0],["ItemGPS",1,0],
				["Exile_Item_BBQSandwich_Cooked",1,2],["Exile_Item_BBQSandwich_Cooked",1,2],
				["Exile_Item_Beer",1,3],["Exile_Item_Beer",1,3],["Exile_Item_Beer",1,3],
				["Exile_Item_Catfood_Cooked",1,2],["Exile_Item_Catfood_Cooked",1,2],
				["Exile_Item_ChristmasTinner_Cooked",1,2],["Exile_Item_ChristmasTinner_Cooked",1,2],
				["Exile_Item_Energydrink",1,3],["Exile_Item_Energydrink",1,3],
				["Exile_Item_GloriousKnakworst_Cooked",1,2],["Exile_Item_GloriousKnakworst_Cooked",1,2],
				["Exile_Item_InstaDoc",1,3],["Exile_Item_InstaDoc",1,3],
				["Exile_Item_PlasticBottleFreshWater",1,2],["Exile_Item_PlasticBottleFreshWater",1,2],["Exile_Item_PlasticBottleFreshWater",1,2],["Exile_Item_PlasticBottleFreshWater",1,2],
				["Exile_Item_SausageGravy_Cooked",1,2],["Exile_Item_SausageGravy_Cooked",1,2],
				["Exile_Item_Surstromming",1,2],["Exile_Item_Surstromming",1,2]
			],
			[ // Backpacks
				["B_HuntingBackpack",1,0],["B_HuntingBackpack",1,0],["B_HuntingBackpack",1,0],
				["B_Carryall_cbr",1,0],["B_Carryall_khk",1,0],["B_Carryall_mcamo",1,0],["B_Carryall_ocamo",1,0],["B_Carryall_oli",1,0],["B_Carryall_oucamo",1,0]
			]
	];

	blck_lootCountsMajor2 = [7,16,6,10,10,4]; // Green
	blck_BoxesLoot_Major2 =
		[
			...
			[//Magazines
				...
				["20Rnd_762x51_Mag",7,7],
				["200Rnd_65x39_cased_Box",3,6],
				["100Rnd_65x39_caseless_mag",3,6],
				["130Rnd_338_Mag",2,5],
				["10Rnd_338_Mag",2,4],
				["10Rnd_127x54_Mag",2,4],
				["10Rnd_93x64_DMR_05_Mag",2,5]
			],
			[  // Attachments
				["muzzle_snds_338_black",1,0],["muzzle_snds_338_green",1,0],["muzzle_snds_338_sand",1,0],
				["muzzle_snds_93mmg",1,0],["muzzle_snds_93mmg_tan",1,0],
			...
			[// Basebuilding & hardware
				...
				["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],
				["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],
				["Exile_Item_DuctTape",2,3],
				["Exile_Item_JunkMetal",1,3],["Exile_Item_JunkMetal",1,3],["Exile_Item_JunkMetal",1,3],["Exile_Item_JunkMetal",1,3],
				["Exile_Item_MetalBoard",1,2],["Exile_Item_MetalBoard",1,2],["Exile_Item_MetalBoard",1,2],
				["Exile_Item_FortificationUpgrade",1,1],["Exile_Item_FortificationUpgrade",1,0]
			],
			[//Items
				["Rangefinder",1,0],["Rangefinder",1,0],["Rangefinder",1,0],
				["ItemGPS",1,0],["ItemGPS",1,0],["ItemGPS",1,0],["ItemGPS",1,0],
				["Exile_Item_BBQSandwich_Cooked",1,2],["Exile_Item_BBQSandwich_Cooked",1,2],
				["Exile_Item_Beer",1,3],["Exile_Item_Beer",1,3],["Exile_Item_Beer",1,3],
				["Exile_Item_Catfood_Cooked",1,2],["Exile_Item_Catfood_Cooked",1,2],
				["Exile_Item_ChristmasTinner_Cooked",1,2],["Exile_Item_ChristmasTinner_Cooked",1,2],
	...
	blck_lootCountsMinor = [4,6,3,3,6,1];   // Blue - weapons, mags, attachments, basebuilding, items, backpacks
	blck_BoxesLoot_Minor = // blue
		[
			[// Weapons
				["arifle_Katiba_F","30Rnd_65x39_caseless_green"],
				["arifle_Katiba_GL_F","30Rnd_65x39_caseless_green"],
				["arifle_Mk20_F","30Rnd_556x45_Stanag"],["arifle_Mk20_F","30Rnd_556x45_Stanag"],
				["arifle_Mk20_plain_F","30Rnd_556x45_Stanag"],["arifle_Mk20_plain_F","30Rnd_556x45_Stanag"],
				["arifle_Mk20C_F","30Rnd_556x45_Stanag"],["arifle_Mk20C_F","30Rnd_556x45_Stanag"],
				...
				["arifle_MXM_F","30Rnd_65x39_caseless_mag"],
				["arifle_SDAR_F","20Rnd_556x45_UW_mag"],["arifle_SDAR_F","20Rnd_556x45_UW_mag"],
				["arifle_TRG20_F","30Rnd_556x45_Stanag"],["arifle_TRG20_F","30Rnd_556x45_Stanag"],
				["Hgun_PDW2000_F","30Rnd_9x21_Mag"],["Hgun_PDW2000_F","30Rnd_9x21_Mag"],["Hgun_PDW2000_F","30Rnd_9x21_Mag"],
			...
			[//Magazines
				["3rnd_HE_Grenade_Shell",1,1],
				["30Rnd_65x39_caseless_green",3,2],
				["30Rnd_65x39_caseless_mag",3,2],
				["30Rnd_556x45_Stanag",3,3],
				["30Rnd_45ACP_Mag_SMG_01",3,3],
				["20Rnd_556x45_UW_mag",3,6],
				["20Rnd_762x51_Mag",3,3],
				["10Rnd_762x55_Mag",3,3],
				["200Rnd_65x39_cased_Box",1,2],
				["100Rnd_65x39_caseless_mag_Tracer",2,2],
				["HandGrenade",1,2],
				["10Rnd_338_Mag",1,1],
				["10Rnd_127x54_Mag" ,1,1],
				["10Rnd_93x64_DMR_05_Mag",1,1]
			],
			[  // Attachments
				["optic_SOS",1,0],
				["optic_DMS",1,0],["optic_DMS",1,0],
				["optic_Holosight",1,0],["optic_Holosight",1,0],
				["optic_Arco",1,0],["optic_Arco",1,0],
				["optic_Hamr",1,0],["optic_Hamr",1,0],
				["optic_MRCO",1,0],["optic_MRCO",1,0],
				["optic_Yorris",1,0],["optic_Yorris",1,0],["optic_Yorris",1,0],
				["optic_MRD",1,0],["optic_MRD",1,0],
				["muzzle_snds_H",1,0],["muzzle_snds_L",1,0],["muzzle_snds_M",1,0],["muzzle_snds_B",1,0],["muzzle_snds_H_MG",1,0],["muzzle_snds_acp",1,0]
			],
			[	// Basebuilding & hardware
				["Exile_Item_WoodFloorKit",2,8],
				["Exile_Item_WoodWallKit",4,6],
				["Exile_Item_WoodPlank",5,20],
				["Exile_Item_Matches",1,1],
				["Exile_Item_CookingPot",1,1],
				["Exile_Item_DuctTape",1,2],
				["Exile_Item_JunkMetal",1,1],
				["Exile_Item_LightBulb",1,1],
				["Exile_Item_ExtensionCord",1,1],
				["Exile_Item_CamoTentKit",1,0]
			],
			[//Items
				["Binocular",1,1],["Binocular",1,1],
				["Exile_Melee_Axe",1,1],
				["Exile_Item_BBQSandwich",1,1],
				["Exile_Item_Beer",1,1],
				["Exile_Item_Catfood",1,1],
				["Exile_Item_ChristmasTinner",1,1],
				["Exile_Item_Energydrink",1,1],
				["Exile_Item_GloriousKnakworst",1,1],
				["Exile_Item_InstaDoc",1,1],
				["Exile_Item_PlasticBottleEmpty",1,1],["Exile_Item_PlasticBottleEmpty",1,1],["Exile_Item_PlasticBottleEmpty",1,1],["Exile_Item_PlasticBottleEmpty",1,1],
				["Exile_Item_PlasticBottleFreshWater",1,1],
				["Exile_Item_SausageGravy",1,1],
				["Exile_Item_Surstromming",1,1]
			],
			[ // Backpacks
				["B_FieldPack_blk",1,0],["B_FieldPack_cbr",1,0],["B_FieldPack_ocamo",1,0],["B_FieldPack_oucamo",1,0],
				["B_TacticalPack_blk",1,0],["B_TacticalPack_rgr",1,0],["B_TacticalPack_ocamo",1,0],["B_TacticalPack_mcamo",1,0],["B_TacticalPack_oli",1,0]
			]
	];

	blck_lootCountsMinor2 = [5,12,4,6,6,2];  // Red - weapons, mags, attachments, basebuilding, items, backpacks
	blck_BoxesLoot_Minor2 =
		[
			[// Weapons
				...
				["arifle_Mk20_GL_F","30Rnd_556x45_Stanag"],["arifle_Mk20_GL_F","30Rnd_556x45_Stanag"],
				["arifle_Mk20_GL_plain_F","30Rnd_556x45_Stanag"],["arifle_Mk20_GL_plain_F","30Rnd_556x45_Stanag"],
				["arifle_MX_F","30Rnd_65x39_caseless_mag"],["arifle_MX_F","30Rnd_65x39_caseless_mag"],
				["arifle_MXC_F","30Rnd_65x39_caseless_mag"],["arifle_MXC_F","30Rnd_65x39_caseless_mag"],
				["arifle_MXM_F","30Rnd_65x39_caseless_mag"],
				["arifle_SDAR_F","20Rnd_556x45_UW_mag"],
				["arifle_TRG20_F","30Rnd_556x45_Stanag"],
				["arifle_MXM_F","30Rnd_65x39_caseless_mag_Tracer"],
				["arifle_MXM_Black_F","30Rnd_65x39_caseless_mag_Tracer"],
				["srifle_DMR_01_F","10Rnd_762x55_Mag"],["srifle_DMR_01_F","10Rnd_762x55_Mag"],
				["srifle_EBR_F","20Rnd_762x51_Mag"],["srifle_EBR_F","20Rnd_762x51_Mag"],
				["LMG_Mk200_F","200Rnd_65x39_cased_Box_Tracer"],["LMG_Mk200_F","200Rnd_65x39_cased_Box_Tracer"],
				["Arifle_MX_SW_F","100Rnd_65x39_caseless_mag_Tracer"],["Arifle_MX_SW_F","100Rnd_65x39_caseless_mag_Tracer"],
			...
			[//Magazines
				["3rnd_HE_Grenade_Shell",1,1],
				["30Rnd_65x39_caseless_green",3,2],
				["30Rnd_65x39_caseless_mag",3,2],["30Rnd_65x39_caseless_mag",3,2],
				["30Rnd_556x45_Stanag",3,3],
				["30Rnd_45ACP_Mag_SMG_01",3,3],
				["20Rnd_556x45_UW_mag",3,6],
				["20Rnd_762x51_Mag",3,3],["20Rnd_762x51_Mag",3,3],
				["10Rnd_762x55_Mag",3,3],["10Rnd_762x55_Mag",3,3],
				["200Rnd_65x39_cased_Box",1,2],["200Rnd_65x39_cased_Box",1,2],
				["100Rnd_65x39_caseless_mag_Tracer",2,2],["100Rnd_65x39_caseless_mag_Tracer",2,2],
				["HandGrenade",1,2],
				["10Rnd_338_Mag",1,1],
				["10Rnd_127x54_Mag" ,1,1],
				["10Rnd_93x64_DMR_05_Mag",1,1]
			...
			[  // Attachments
				...
				["muzzle_snds_H",1,0],["muzzle_snds_L",1,0],["muzzle_snds_M",1,0],["muzzle_snds_B",1,0],["muzzle_snds_H_MG",1,0],["muzzle_snds_acp",1,0],
				["muzzle_snds_H",1,0],["muzzle_snds_L",1,0],["muzzle_snds_M",1,0],["muzzle_snds_B",1,0],["muzzle_snds_H_MG",1,0],["muzzle_snds_acp",1,0],
				["muzzle_snds_338_black",1,0],["muzzle_snds_93mmg",1,0],
				["optic_AMS_khk",1,0],["optic_KHS_old",1,0]
			],
			[// Basebuilding & hardware
				["Exile_Item_WoodFloorKit",4,6],["Exile_Item_WoodFloorKit",4,6],
				["Exile_Item_WoodWallKit",4,8],["Exile_Item_WoodWallKit",4,8],
				["Exile_Item_WoodPlank",8,20],["Exile_Item_WoodPlank",8,20],
				["Exile_Item_Matches",1,1],
				["Exile_Item_CookingPot",1,1],
				["Exile_Item_DuctTape",1,2],["Exile_Item_DuctTape",1,2],
				["Exile_Item_JunkMetal",1,2],["Exile_Item_JunkMetal",1,2],
				["Exile_Item_MetalBoard",1,1],
				["Exile_Item_CamoTentKit",1,0]
			],
			[//Items
				["Rangefinder",1,1],
				...
				["Binocular",1,0],
				["Exile_Melee_Axe",1,0],
				["Exile_Item_BBQSandwich_Cooked",1,0],
				["Exile_Item_Beer",1,1],
				["Exile_Item_Catfood_Cooked",1,0],
				["Exile_Item_ChristmasTinner_Cooked",1,0],
				["Exile_Item_Energydrink",1,1],
				["Exile_Item_GloriousKnakworst_Cooked",1,0],
				["Exile_Item_InstaDoc",1,1],
				["Exile_Item_PlasticBottleEmpty",1,1],["Exile_Item_PlasticBottleEmpty",1,1],
				["Exile_Item_PlasticBottleFreshWater",1,1],["Exile_Item_PlasticBottleFreshWater",1,1],["Exile_Item_PlasticBottleFreshWater",1,1],
				["Exile_Item_SausageGravy_Cooked",1,0],
				["Exile_Item_Surstromming",1,1]
			],
			[ // Backpacks
				["B_Kitbag_cbr",1,0],["B_Kitbag_mcamo",1,0],["B_Kitbag_sgg",1,0],
				["B_Bergen_blk",1,0],["B_Bergen_mcamo",1,0],["B_Bergen_rgr",1,0],["B_Bergen_sgg",1,0],["B_HuntingBackpack",1,0]
			]
	];
